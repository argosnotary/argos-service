...
import com.argosnotary.argos.service.openapi.rest.model.RestReleaseDossierMetaData;
...
public interface ReleaseResultMapper {
    ...
    abstract RestReleaseDossierMetaData maptoRestReleaseDossierMetaData(ReleaseDossierMetaData meta);
