...
public interface RoleAssignmentMapper {
	...
	RoleAssignment convertFromRestRoleAssignment(RestRoleAssignment restRoleAssignment);

    RestRoleAssignment convertToRestRoleAssignment(RoleAssignment roleAssignment);
}
